...
typedef enum { CRL_UNUSED0 = 0, CRL_UNUSED1 = 1, CRL_UNUSED2 = 2 } BbCrlUnusedEnumType;

typedef enum { CRL_TS, CRL_CA, CRL_CP } BbCrlNum;
...
typedef enum { RSA_2048 = 0, RSA_4096 } RsaSize;
